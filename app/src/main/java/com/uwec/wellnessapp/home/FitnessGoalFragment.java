...
public class FitnessGoalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fitness_goal_week.setText(Statics.getGobalGoalData().getWeek());
        ...
        /* create a button for the amount of days they have to do an activity  */
        ArrayList<Button> buttons = new ArrayList<Button>();
        for(int i = 0; i < Statics.getGobalGoalData().getPa_days_per_week(); i++) {
